...
from aix360_k.aix360.algorithms.rule_induction.trxf.core.boolean_evaluator import BooleanEvaluator
from aix360_k.aix360.algorithms.rule_induction.trxf.core.feature import Feature, is_number
...
class Predicate(BooleanEvaluator):
    ...
    def evaluate(self, assignment: Dict[str, Any]) -> bool:
        ...
        if self.relation == Relation.EQ:
            return math.isclose(feature_val, int(self.value), abs_tol=ABS_TOL) if is_number(self.value) \

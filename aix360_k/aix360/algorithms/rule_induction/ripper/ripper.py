...
class RipperExplainer(DISExplainer):
    ...
    def fit(self, train: DataFrame, y: Series, target_label=None):
        ...
        expand_log = tqdm(total=len(self._labels) - 1, desc='RIPPER expanding process', position=0)
        ...
        optimization_log = tqdm(total=self.k, desc='RIPPER optimization process', position=1)

...
def get_args():
    ...
    parser.add_argument("--dataset", choices=["twopairs", "threepairs", "red-triangle", "closeby",
                                              "online", "online-pair", "nine-circles", "clevr-hans0", "clevr-hans1", "clevr-hans2"], help="Use kandinsky patterns dataset", default="twopairs")
    parser.add_argument("--dataset-type", default="kandinsky",
                        help="kandinsky or clevr")
    parser.add_argument('--device', default='cpu',
                        help='cuda device, i.e. 0 or cpu')
    parser.add_argument("--no-cuda", default=True,
    ...
    parser.add_argument("--t-beam", type=int, default=5,
...
0            clauses, T_beam=args.t_beam, N_beam=args.n_beam, N_max=args.n_max)

...
if __name__ == "__main__":
    ...
    # ! config for images 
    parser.add_argument('--target_predicate', type=str, default='gcor', help='target predicate, can be lessthan or predicate inside the dataset')
    parser.add_argument("--task", type=str, default='gcor', help='task name. Choose from mnist, relational_images, even, lessthan....')
    ...
    parser.add_argument('--minimal_precision', type=float, default=0.73, help='the least precision the rules in the learned ruleset')

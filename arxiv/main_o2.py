...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr_predicate', type=float, default=1e-5)
    ...
    parser.add_argument('--target_predicate', type=str, default='odd', help='target predicate')
    parser.add_argument("--task", type=str, default='odd')

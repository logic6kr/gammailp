...
def get_argparser():
    ...
    arg = a.add_argument
    arg('--command', type=str, default='test',help='train|test|finetune|paraphrase, need to determined')
    ...
    arg('--datadir', type=Path, default='cache')
    arg('--task-name', type=Path, default='icews14')
    ...
    arg('--top-n', type=int, default=10, help='need to determined')
    arg('--n-facts', type=int,  default=10, help='need to determined')
    arg('--entity-repr', type=str,  default='symbol', help='need to determined')

    arg('--wikidata-dir', type=Path, default='cache/icews14/')
    ...
    arg('--architecture', type=str, choices=['lstm', 'transformer'],  default='lstm', help='need to determined')
    arg('--tokenizer', type=str, default='roberta-base')
    arg('--model-file', type=Path, default='out/54/checkpoint_acc=0.6860.pt', help='need to determined')
    arg('--no-fp16', action='store_true')
    arg('--no-load-state', action='store_true')
    arg('--no-load-optim', action='store_true')

    arg('--n-layers', type=int, default=2, help='need to determined')
    arg('--n-hidden', type=int, default=1024, help='need to determined')
    ...
    arg('--kb-emb-random-init', action='store_true', default=True, help='need to determined')
    ...
    arg('--batch-size', type=int, default=128, help='need to determined')
    ...
    arg('--lr', type=float, default=5e-5, help='need to determined')
    ...
    arg('--early-stopping', type=int, default=20, help='need to determined')
    ...
    arg('--max-test-inst', type=int, default=100000)
    arg('--test-data-path', type=str, default='data/wikidata_relation_statements/infer.jl', help='need to determined')
